...
## Explore Pantone by Color Family

Looking for a specific shade? We've compiled comprehensive guides for every major Pantone color family, complete with hex codes, CMYK values, and brand examples:

[Pantone Red](/pantone-red/) | [Pantone Blue](/pantone-blue/) | [Pantone Green](/pantone-green/) | [Pantone Yellow](/pantone-yellow/) | [Pantone Orange](/pantone-orange/) | [Pantone Pink](/pantone-pink/) | [Pantone Purple](/pantone-purple/) | [Pantone Gold](/pantone-gold/) | [Pantone Black](/pantone-black/) | [Pantone White](/pantone-white/)
...
## Consistency Across Materials, Not Just Media

Most brand guidelines stop at PMS, CMYK, RGB and HEX — which covers print and screen and nothing
else. The moment a brand makes physical product, that list is incomplete, and the gaps are where
colour drift creeps in.

A mature brand book adds a line for each material the brand actually produces in. Coatings and
signage need a [RAL](/pantone-to-ral/) or [NCS](/pantone-to-ncs/) reference; interiors and retail
fit-out need a paint colour your contractors can buy, whether that is
[Sherwin-Williams](/pantone-to-sherwin-williams/), [Benjamin Moore](/pantone-to-benjamin-moore/) or
[Dulux](/pantone-to-dulux/); apparel and merchandise need a
[Pantone TCX](/pantone-c-to-tcx/) textile standard, and printed garment work needs
[Siser HTV](/pantone-to-siser-htv/).

This also runs in reverse more often than people expect. Plenty of manufacturers settled on a
product colour decades before they had a brand book — a machine finish, a shopfront, a fleet livery
specified in RAL and never written down in Pantone. When the printed collateral has to match the
physical thing rather than the other way round, [RAL to Pantone](/ral-to-pantone/) is where the
brand book starts.

Underneath all of them, the only way to make consistency enforceable rather than aspirational is to
express the target in measurable terms. Convert the brand colour to
[CIELAB](/pantone-to-lab/), agree a ΔE tolerance with each supplier in writing, and check incoming
work with [LAB to Pantone](/lab-to-pantone/). "Match our red" is an opinion; "ΔE*00 ≤ 2.0 against
these Lab values" is a specification.
