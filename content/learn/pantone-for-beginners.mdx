...
## Where Pantone Stops and Other Systems Begin

Once you are comfortable reading PMS codes, the next thing worth knowing is that Pantone is not
the only colour system you will meet — and that Pantone itself runs more than one.

If your colour is heading for **paint or a coating**, European suppliers work in
[RAL](/pantone-to-ral/) and Scandinavian architecture in [NCS](/pantone-to-ncs/); US retail paint
is easier to specify through [Sherwin-Williams](/pantone-to-sherwin-williams/) or
[Behr](/pantone-to-behr/). If it is heading for **something you make by hand**, there are
converters for [DMC embroidery floss](/pantone-to-dmc/), [Copic markers](/pantone-to-copic/) and
[cutting vinyl](/pantone-to-oracal/).

And if you work in **fashion or interiors**, be aware that Pantone maintains a second, separate
library for textiles whose codes look like `19-4052 TCX` rather than `186 C`. Start with
[Pantone C to TCX](/pantone-c-to-tcx/) and the [TCX vs TPX vs TPG guide](/tcx-vs-tpx-vs-tpg/) —
mixing the two libraries up is one of the most common and most expensive beginner mistakes.
