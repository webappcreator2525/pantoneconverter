...
export function FavoritesProvider({ children }) {
  ...
  // Hydrate once on client. localStorage cannot be read during a server render
  // without desyncing the hydrated markup, so seeding from a mount effect is the
  // correct pattern here rather than an avoidable cascading render.
